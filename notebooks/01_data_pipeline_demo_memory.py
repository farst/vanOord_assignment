...
# MAGIC %md
# MAGIC # Memory-Based Data Pipeline Demo: CSV to Parquet to Delta Lake
# MAGIC
# MAGIC This notebook demonstrates:
# MAGIC 1. Reading CSV data from memory
# MAGIC 2. Data cleaning and transformation
# MAGIC 3. Writing to Parquet format using temporary views
# MAGIC 4. Converting to Delta Lake with versioning
# MAGIC 5. Time travel and audit capabilities
# MAGIC
# MAGIC **Note**: This version uses only in-memory operations and temporary views to avoid any storage authentication issues.
...
# MAGIC %md
# MAGIC ## Step 3: Create Temporary Views (In-Memory)
...
# MAGIC %md
# MAGIC ## Step 4: Demonstrate Data Processing Patterns
...
# MAGIC %md
# MAGIC ## Step 5: Simulate Delta Lake Versioning with Multiple Views
...
# MAGIC %md
# MAGIC ## Step 6: Simulate Time Travel Queries
...
# MAGIC %md
# MAGIC ## Step 8: Advanced Analytics
...
print("✅ Memory-Based Data Pipeline Demo Complete!")
print("📊 Created temporary views:")
print("   - invoices_raw (original data)")
print("   - invoices_parquet_view (cleaned data)")
